            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/locations/edit/'.$getlocation->id)}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="street_address" class="form-control"  value="{{$getlocation->street_address}}" placeholder="Street Address"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="postal_code" class="form-control"  value="{{$getlocation->postal_code}}" placeholder="Postal Code"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="city" class="form-control"  value="{{$getlocation->city}}" placeholder="City"  required>
                                        @if ($errors->has('city'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="state_provice" class="form-control"  value="{{$getlocation->state_provice}}" placeholder="Postal Code"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name ="countries_id" required>
                                            ...
                                            <option value="{{$value->id}}" {{ ($value->id == $getlocation->countries_id) ? 'selected' : ''}}>{{$value->country_name}}</option>
