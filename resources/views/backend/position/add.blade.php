            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/position/add')}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="position_name" class="form-control"  value="{{old('position_name')}}" placeholder="Enter Position Name"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="daily_rate" class="form-control"  value="{{old('daily_rate')}}" placeholder="Enter Daily Rate"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="monthly_rate" class="form-control"  value="{{old('monthly_rate')}}" placeholder="Enter Monthly Rate"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="working_days_per_month" class="form-control"  value="{{old('working_days_per_month')}}" placeholder="Enter Working Days Per Month"  required>
