            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/countries/edit/'.$getcountries->id)}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="country_name" class="form-control" placeholder="Country Name"  value="{{$getcountries->country_name}}"  required>
                                        ...
                                        <select name="regions_id" id="" class="form-control" required> 
                                            <option value="">Select Regions Name</option>
                                                @foreach ($getRegions as $value)
                                                    <option value="{{$value->id}}" {{ ($value->id == $getcountries->regions_id) ? 'selected' : ''}}>{{$value->regions_name}}</option>
                                                @endforeach
                                        </select>
