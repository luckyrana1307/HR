            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/payroll/edit/'.$getPayroll->id)}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name ="employee_id">
                                            ...
                                            @foreach ($getRecord as $vlaue_employee)
                                                <option {{($vlaue_employee->id == $getPayroll->employee_id) ? 'selected' : ''}} value="{{$vlaue_employee->id}}">{{$vlaue_employee->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="number_of_day_work" class="form-control"  value="{{$getPayroll->number_of_day_work}}" placeholder="Number Of Day Work"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="bonus" class="form-control"  value="{{$getPayroll->bonus}}" placeholder="Enter Bonus"  required>
                                        @if ($errors->has('bonus'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="overtime" class="form-control"  value="{{$getPayroll->overtime}}" placeholder="Enter Overtime"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="gross_salary" class="form-control"  value="{{$getPayroll->gross_salary}}" placeholder="Enter Gross Salary"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="cash_advance" class="form-control"  value="{{$getPayroll->cash_advance}}" placeholder="Enter Cash Advance"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="late_hours" class="form-control"  value="{{$getPayroll->late_hours}}" placeholder="Enter Late Hours"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="absent_days" class="form-control"  value="{{$getPayroll->absent_days}}" placeholder="Enter Absent Days"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sss_contribution" class="form-control"  value="{{$getPayroll->sss_contribution}}" placeholder="Enter SSS Contribution"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="philhealth" class="form-control"  value="{{$getPayroll->philhealth}}" placeholder="Enter Philhealth"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="total_deductions" class="form-control"  value="{{$getPayroll->total_deductions}}" placeholder="Enter Total Deductions"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="netpay" class="form-control"  value="{{$getPayroll->netpay}}" placeholder="Enter Netpay"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="payroll_monthly" class="form-control"  value="{{$getPayroll->payroll_monthly}}" placeholder="Enter Payroll Monthly"  required>
