            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/jobs/add')}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="job_title" class="form-control"  value="{{old('job_title')}}"  placeholder="Job Title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="min_salary" class="form-control"  value="{{old('min_salary')}}"  placeholder="Min Salary" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="max_salary" class="form-control"  value="{{old('max_salary')}}"  placeholder="Max Salary" required>
