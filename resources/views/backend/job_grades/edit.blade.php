            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/job_grades/edit/'.$getRecord->id)}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="grade_level" class="form-control" placeholder="Grade Level"  value="{{$getRecord->grade_level}}"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="lowest_sal" class="form-control" placeholder="Lowest Sal"  value="{{$getRecord->lowest_sal}}"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="highest_sal" class="form-control" placeholder="Highest Sal"  value="{{$getRecord->highest_sal}}"  required>
