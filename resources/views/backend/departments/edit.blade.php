            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('admin/departments/edit/'.$getdepartment->id)}}">
                            {{ csrf_field() }}  
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="department_name" class="form-control"  value="{{$getdepartment->department_name}}"  placeholder="Department Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="manager_id" id="">
                                            ...
                                            <option {{($getdepartment ->manager_id == 1 ? 'selected' : '' )}} value="1">Lucky</option>
                                            <option  {{($getdepartment ->manager_id == 2 ? 'selected' : '' )}} value="2">Roy</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="locations_id" id="">
                                            ...
                                            <option value=""></option>
                                            <option value="{{$value->id}}" {{ ($value->id == $getdepartment->locations_id) ? 'selected' : ''}}>{{$value->street_address}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
